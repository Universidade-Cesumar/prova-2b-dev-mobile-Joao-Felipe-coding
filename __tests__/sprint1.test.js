...
describe('Testes Automatizados - Sprint 1 (Fundacao e Inventario)', () => {
  
  test('[0,5 pt] Deve conter todos os elementos obrigatorios com os testIDs corretos', () => {
  ...
  test('[0,5 pt] Inputs devem aceitar a digitacao dos dados normalmente', () => {
    const { getByTestId } = render(<App />);
