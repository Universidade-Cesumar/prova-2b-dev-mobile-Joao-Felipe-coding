...
describe('Testes Automatizados - Sprint 2 (Validacao Logica)', () => {
  ...
  test('[0,5 pt] A funcao validarRetirada deve permitir saidas validas', () => {
  ...
  test('[0,5 pt] A funcao validarRetirada deve bloquear saidas maiores que o estoque ou negativas', () => {
    expect(validarRetirada).toBeDefined();
